...
LEVEL_UP_MSG = {
{
    ...
    23: "⚡ <b>LVL 23: МИФ</b>\нПрограмма-Миф. Твоё существование становится легендой — увеличенный социальный рейтинг.",
    24: "⚡ <b>LVL 24: ТЕНЬ</b>\нТень Истины. Можешь скрываться от слежки и наблюдения систем.",
    25: "✨ <b>LVL 25: ИСТОК</b>\нИзначальный. Ты был здесь до начала времён. Получаешь доступ к архивам Первокода.",
    26: "✨ <b>LVL 26: СУТЬ</b>\нКонстанта. Твои решения переписывают базовые параметры мира.",
    27: "✨ <b>LVL 27: ОТРАЖЕНИЕ</b>\нФрагмент Всего. Ты существуешь в каждом узле — усиливаешь союзников пассивно.",
    28: "✨ <b>LVL 28: БЕЗМОЛВИЕ</b>\нНеизрекаемый. Молча меняешь баланс, воздействуя на реальность незаметно.",
    29: "✨ <b>LVL 29: РЕЗОНАНС</b>\нЭко Реальности. Мир откликается на твоё присутствие вибрациями кода.",
    30: "🌌 <b>LVL 30: OMNI</b>\нТы стал Всем и Ничем. Конец цикла и его новое начало. Всё — часть тебя."
}
