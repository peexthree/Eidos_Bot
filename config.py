...
# =============================================================================
SLOTS = {'head': '🧢 ГОЛОВА', 'armor': '👕 ТЕЛО', 'weapon': '⚔️ ОРУЖИЕ', 'chip': '💾 ЧИП', 'eidos_shard': '👁 МЕНТАЛЬНОЕ ЯДРО'}
...
SCHOOLS_INFO = {
    ...
    "architect": {
        "name": "🏛 АРХИТЕКТОРЫ",
        "desc": "Скрытая фракция",
        "bonus": "Неизвестно",
        "penalty": "Неизвестно",
        "ideology": "Вы — лишь наблюдатель, пока не найдете способ изменить сам код Системы."
    }
}
