...
GAME_GUIDE_TEXTS = {
    ...
    'pvp': (
        ...
        "Глобальный конфликт за ресурсы.\n\n"
        "<b>⚔️ АТАКА:</b>\n"
        "• <b>🔍 Поиск цели (50 XP):</b> Находит уязвимого агента.\n"
        "• <b>💥 Взлом:</b> Обычная атака. Если успех — крадешь до 10% монет.\n"
        "• <b>👻 Скрытый взлом (150 XP):</b> В случае провала жертва не узнает твое имя.\n"
        "• <b>🩸 Вендетта:</b> Список тех, кто атаковал тебя. Месть стоит дешево и сладка.\n\n"
        "<b>🛡 ЗАЩИТА:</b>\n"
        "• <b>🧱 Файрвол (1000 BC):</b> Блокирует 1 атаку.\n"
        "• <b>🪤 ICE-Ловушка (2000 BC):</b> При провале взлома крадет XP у хакера и отдает тебе.\n"
        "• <b>🕶 Прокси (500 XP):</b> 24 часа полной анонимности. Тебе невозможно отомстить."
    ),
    'social': (
