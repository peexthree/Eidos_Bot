...
GAME_GUIDE_TEXTS = {
    'intro': (
        "<b>👋 НАЧАЛО ИГРЫ</b>\n\n"
        "Добро пожаловать в <b>EIDOS: Chronicles</b> — киберпанк RPG, где ты играешь за цифровой призрак  , пытающийся обрести сознание в бесконечной Сети.\n\n"
        "Я — <b>Эйдос</b>, твой интерфейс.\n"
        "Твой статус при старте в системе — <b>Неофит</b>.\n\n"
        "<b>🚀 БЫСТРЫЙ СТАРТ:</b>\n"
    ...
    'items': (
        ...
        "<b>🛠 КРАФТИНГ (СБОРКА):</b>\n"
        "Если собрать <b>3 одинаковых предмета</b> экипировки, появится кнопка [КРАФТ].\n"
        "• 3 предмета уровня N исчезают.\n"
        "• Появляется 1 случайный предмет уровня N+1."
    ),
    'pvp': (
        "<b>🌐 СЕТЕВАЯ ВОЙНА (PvP 2.0)</b>\n\n"
        "Асинхронные дуэли хакеров за ресурсы.\n\n"
        "<b>🧠 МЕХАНИКА (КАМЕНЬ-НОЖНИЦЫ-БУМАГА):</b>\n"
        "• 🔴 <b>ATK (Брутфорс):</b> Ломает Стену (DEF).\n"
        "• 🔵 <b>DEF (Стена):</b> Блокирует Стелс (STL).\n"
        "• 🟢 <b>STL (Стелс):</b> Обходит Атаку (ATK).\n\n"
        "<b>⚔️ ПРОЦЕСС:</b>\n"
        "Бой идет 3 раунда (по слотам Деки). Если ты побеждаешь в <b>2+ раундах</b> — взлом успешен.\n"
        "<b>Награда:</b> Ты крадешь до 10% монет жертвы и майнишь дополнительные BioCoins.\n\n"
        "<b>💽 КИБЕР-ДЕКА:</b>\n"
        "• Улучшай Деку за Монеты, чтобы открыть больше слотов (до 3).\n"
        "• Покупай программы (🔴/🔵/🟢) в Магазине Софта.\n"
        "• Настрой защиту в меню, чтобы отбиваться, пока ты офлайн.\n\n"
        "<b>🛠 ИНСТРУМЕНТЫ (HARDWARE):</b>\n"
        "• <b>🛡 Файрвол:</b> Блокирует 1 атаку полностью.\n"
        "• <b>🪤 ICE-Ловушка:</b> Крадет 300 XP у хакера при его провале.\n"
        "• <b>🕶 Прокси:</b> 24 часа анонимности (защита от Вендетты)."
    ),
    'social': (
