...
GAME_GUIDE_TEXTS = {
    ...
    'pvp': (
        ...
        "Асинхронные дуэли хакеров за валюту <b>DATA</b>.\n\n"
        ...
        "<b>Награда:</b> Ты крадешь до 10% монет жертвы и получаешь DATA.\n\n"
        "<b>💽 КИБЕР-ДЕКА:</b>\n"
        "• Улучшай Деку за DATA, чтобы открыть больше слотов (до 3).\n"
