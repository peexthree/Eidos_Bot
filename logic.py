...
GAME_GUIDE_TEXTS = {
    'intro': (
        ...
        "<b>📱 ИНТЕРФЕЙС:</b>\n"
        "• <b>💠 СИНХРОН:</b> Основной источник XP (раз в 30 мин).\n"
        "• <b>📡 СИГНАЛ:</b> Доп. опыт (раз в 5 мин).\n"
        "• <b>🚀 РЕЙД:</b> Опасная вылазка за лутом.\n"
        "• <b>👤 ПРОФИЛЬ:</b> Статистика и прогресс.\n"
        "• <b>🎒 ИНВЕНТАРЬ:</b> Твои вещи.\n"
        "• <b>🎰 РЫНОК:</b> Магазин снаряжения."
    ),
    'raids': (
        ...
        "<b>💀 СМЕРТЬ:</b>\n"
        "Твое здоровье — это <b>Сигнал</b>. Если он упадет до 0%, ты умрешь и <b>ПОТЕРЯЕШЬ ВЕСЬ ЛУТ</b> за рейд. Эвакуируйся вовремя!"
    ),
    'combat': (
        "<b>⚔️ БОЕВАЯ СИСТЕМА</b>\n\n"
        "Встретив врага, у тебя есть выбор:\n\n"
        "1. <b>⚔️ АТАКА:</b> Наносишь урон (зависит от ATK).\n"
    ...
    'stats': (
        ...
        "<b>📈 УРОВНИ (1-30):</b>\n"
        "С каждым уровнем ты получаешь новый Титул и становишься сильнее.\n\n"
        "<b>📉 СТАТЫ:</b>\n"
        "• <b>⚔️ ATK:</b> Урон в бою.\n"
        "• <b>🛡 DEF:</b> Защита от врагов и ловушек.\n"
        "• <b>🍀 LUCK:</b> Шанс крита, лучшего лута и успешного побега.\n\n"
        "<b>🧬 ФРАКЦИИ (БОНУСЫ):</b>\n"
        "• <b>🏦 МАТЕРИЯ:</b> +20% Монет в рейдах.\n"
        "• <b>🧠 РАЗУМ:</b> +10 к Защите.\n"
        "• <b>🤖 ТЕХНО:</b> +10 к Удаче."
    ),
    'items': (
        "<b>🎒 ПРЕДМЕТЫ И ЭКИПИРОВКА</b>\n\n"
        "<b>👘 СЛОТЫ:</b>\n"
        "Ты можешь надеть шлем, броню, оружие и чип.\n\n"
        "<b>📦 РАСХОДНИКИ:</b>\n"
        "• <b>🔋 Батарея:</b> +30% Сигнала (HP).\n"
        "• <b>💉 Стимулятор:</b> +60% Сигнала.\n"
        "• <b>🧭 Компас:</b> Показывает тип следующей комнаты.\n"
        "• <b>🗝 Ключи:</b> Открывают сундуки (Магнитная отмычка, Ключ Бездны).\n"
        "• <b>💾 Дата-шип:</b> Одноразовый взлом сундука (80% шанс)."
    ),
    'pvp': (
        ...
        "🛡 <b>ЗАЩИТА:</b> Купи предмет <b>Файрвол</b> в магазине. Он заблокирует атаку."
    ),
    'social': (
    ...
    'tips': (
        ...
        "1. Не жадничай в Рейдах. Если HP < 30% — эвакуируйся!\n"
        "2. Купи <b>Ржавый Тесак</b> как можно скорее.\n"
        "3. Всегда носи <b>Магнитную Отмычку</b> для сундуков.\n"
        "4. Заходи каждый день, чтобы растить <b>Стрик</b> (бонус к опыту).\n"
